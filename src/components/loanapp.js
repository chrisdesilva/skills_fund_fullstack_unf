...
const LoanApp = React.forwardRef((props, ref) => {
	...
	//         ReactGA.event({
	//             category: `Apply Now Button | Fullstack UNF`,
	//             action: 'click',
				...
				<Collapse isOpened={disclaimers} springConfig={{ stiffness: 150, damping: 40 }}>
					<div>
						...
						<p>
							...
							and money laundering activities, federal law requires all financial institutions to obtain,
							verify, and record information that identifies each person who opens an account. What this
							means for you: When you open an account, we will ask for your name, address, date of birth
