...
export const leadContent = {
	...
	paragraph: `${schoolName} provides a part-time program to help students build software development skills on any schedule. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving
		? ' and cost of living'
