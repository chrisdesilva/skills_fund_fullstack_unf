...
export const leadContent = {
    ...
    paragraph: `${schoolName} provides a part-time program to help students build software development skills on any schedule. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving ? ' and cost of living' : ''} financing so more students like you can access their program.`
}
...
export const programMaxText = "Choose the loan amount that works best for you. Borrow up to $12,000 for Fullstack's University of North Florida Coding Bootcamp tuition."
